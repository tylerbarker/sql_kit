defmodule SqlDir.Config do
  @moduledoc """
  Runtime configuration access for SqlDir.

  Users configure SqlDir in their application's config:
  ...
  Looks up the `:root_sql_dir` key in the application's SqlDir config.
